            ...
            <div className="divide-y divide-gray-50">
              {customer.devices?.length > 0 ? customer.devices.map(device => (
                <div key={device.id} className="p-4 flex justify-between items-center hover:bg-gray-50">
                  ...
                  <Link href={`/tec/devices/${device.id}`} className="text-sm text-gray-400 hover:text-blue-600">
                    ดูรายละเอียด →
                  </Link>
                </div>
              )) : (
                ...
                <tbody className="divide-y divide-gray-50">
                  {customer.repairs?.length > 0 ? customer.repairs.map(repair => (
                    <tr key={repair.id} className="hover:bg-gray-50">
                      ...
                      <td className="p-4">
                        <Link href={`/tec/repairs/${repair.id}`} className="text-xs font-bold text-gray-500 hover:text-blue-600 underline">
                          ดูรายละเอียด
                        </Link>
                      </td>
                    </tr>
