  ...
  if (loading) return (
    <div className="flex flex-col h-[60vh] items-center justify-center gap-4">
      <div className="relative flex items-center justify-center">
        ...
        <Cpu className="absolute text-blue-600 animate-pulse" size={24} />
      </div>
      <p className="text-gray-400 font-bold text-xs uppercase tracking-widest animate-pulse">Fetching Device Data...</p>
    </div>
  );
