...
export default function DeviceEditPage() {
  ...
  if (loading && !formData.brand) return (
    <div className="flex flex-col h-[60vh] items-center justify-center gap-4">
      <div className="w-12 h-12 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
      <p className="text-gray-400 font-black text-xs animate-pulse tracking-widest uppercase">Preparing Device Data...</p>
    </div>
  );
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Edit Device Info</h1>
          <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Configuration Panel</p>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 rounded-[3rem] border border-gray-50 shadow-xl shadow-gray-200/50 space-y-10">
        
        {/* Device Type Selection */}
        <div className="space-y-4">
          <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">Device Category</label>
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              >
                <div className={`transition-transform duration-500 ${formData.device_type === type.id ? "scale-110" : ""}`}>
                  {type.icon}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-3 group">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2 group-focus-within:text-blue-600 transition-colors">Brand Identity</label>
            <input 
              required
          ...
          <div className="space-y-3 group">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2 group-focus-within:text-blue-600 transition-colors">Model Name</label>
            <input 
              required
          ...
          <div className="md:col-span-2 space-y-3 group">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2 group-focus-within:text-blue-600 transition-colors">Serial Identity</label>
            <div className="relative">
              ...
              <div className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300">
                 <Cpu size={20} className="group-focus-within:text-blue-400 transition-colors" />
              </div>
            </div>
          </div>

          <div className="md:col-span-2 space-y-3 group">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2 group-focus-within:text-blue-600 transition-colors">Technical Details</label>
            <textarea 
              rows="4"
        ...
        <div className="pt-6">
          ...
          >
            <Save size={20} className={loading ? "animate-spin" : "animate-pulse"} /> 
