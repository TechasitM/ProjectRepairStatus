        ...
        <div className="bg-slate-900 p-8 text-white relative">
          <div className="relative z-10">
            ...
            <p className="text-gray-400 text-sm mt-1 font-medium">
              ID: #{id} • แก้ไขข้อมูลพื้นฐานหรือสิทธิ์การเข้าใช้งาน
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-100 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition-all font-semibold text-gray-700"
          ...
          <div className="p-5 bg-blue-50/50 rounded-2xl border border-blue-100/50 space-y-3">
            ...
            <input
              ...
              className="w-full bg-white border border-blue-100 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-medium"
              onChange={(e) => setForm({ ...form, password: e.target.value })}
            />
            <div className="flex items-center gap-2 text-[11px] text-blue-600 font-bold italic">
              <ShieldAlert size={12} />
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
            <button
              type="button"
              onClick={() => router.back()}
              className="px-6 py-3 border border-gray-100 rounded-xl text-gray-500 hover:bg-gray-50 font-bold"
            >
              ยกเลิก
            </button>
            <button
              type="submit"
              className={`bg-blue-600 text-white px-10 py-3 rounded-xl font-bold shadow-md hover:bg-blue-700 transition-all flex items-center justify-center gap-2 ${saving ? "opacity-50 cursor-not-allowed" : ""}`}
              disabled={saving}
            >
              {saving ? (
                "กำลังบันทึก..."
