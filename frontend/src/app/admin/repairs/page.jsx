...
export default function AdminRepairsPage() {
  ...
  const [filteredRepairs, setFilteredRepairs] = useState([]); // สำหรับตัวกรอง
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <Link href="/admin/repairs/create" className="bg-green-600 text-white px-5 py-2 rounded-lg shadow-sm hover:bg-green-700 transition-all active:scale-95 font-medium whitespace-nowrap">
            + เพิ่มงานซ่อมใหม่
          </Link>
        </div>
      </div>
              ...
              <tr key={r.id} className="hover:bg-blue-50/20 transition-colors">
                ...
                <td className="p-4">
                  <div className="font-semibold text-gray-800">
                    {r.device ? `${r.device.brand} ${r.device.model}` : 'ไม่ระบุอุปกรณ์'}
                  </div>
