        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-black text-gray-900 tracking-tight italic">
              DEVICE <span className="text-blue-600">HUB</span>
            </h1>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-9 relative group">
          ...
          <input
            ...
            className="w-full pl-16 pr-6 py-5 bg-white border-none rounded-[2rem] shadow-xl shadow-gray-200/50 focus:ring-4 focus:ring-blue-100 outline-none transition-all font-medium text-gray-700"
            value={searchTerm}
